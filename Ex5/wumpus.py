[23bcs074@mepcolinux ex5]$cat w3.py
import random
...
[23bcs074@mepcolinux ex5]$python3 w3.py
Enter world size (4-10): 6
Enter max actions: 35
Valid indices are 0 to 5
Enter starting row and col for Agent: 5 0

1. Randomly generate world
2. Manually place entities
Select option (1/2): 2
Enter number of pits: 4
Enter row and col for Pit 1: 3 1
Enter row and col for Pit 2: 3 4
Enter row and col for Pit 3: 5 4
Enter row and col for Pit 4: 1 5
Enter row and col for Wumpus: 1 2
Enter row and col for Gold: 0 3
...
Sensors: Smell=False, Breeze=False, Glitter=False, Bump=False, Scream=False
Moves: ['up', 'right']
Remaining actions: 35
Action (up/down/left/right/grab): up
...
Sensors: Smell=False, Breeze=False, Glitter=False, Bump=False, Scream=False
Moves: ['up', 'down', 'right']
Remaining actions: 34
Action (up/down/left/right/grab): right
...
Sensors: Smell=False, Breeze=True, Glitter=False, Bump=False, Scream=False
...
Sensors: Smell=True, Breeze=False, Glitter=False, Bump=False, Scream=False
Moves: ['up', 'down', 'left', 'right']
Remaining actions: 28
Action (up/down/left/right/grab): up
...
Sensors: Smell=False, Breeze=False, Glitter=True, Bump=False, Scream=False
Moves: ['down', 'left', 'right']
Remaining actions: 27
Action (up/down/left/right/grab): grab
Gold grabbed!
...
Script done on Wed Mar  4 16:23:35 2026
[23bcs074@mepcolinux ex5]$
